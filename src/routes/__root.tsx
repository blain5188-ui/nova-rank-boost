...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Nova — Ranked Fortnite con cashback" },
      {
        name: "description",
        content: "Nova: ranked competitivo Fortnite su server EU, ELO, tornei cash e cashback su ogni partita.",
      },
      { property: "og:title", content: "Nova — Ranked Fortnite con cashback" },
      { property: "og:description", content: "Boxfights e Realistics 1v1, 2v2, 3v3 con premi reali." },
